...
const TOKEN_NAME = "DRGON";
const TOKEN_SYMBOL = "DRG";
const TOKEN_DESCRIPTION = "Cute Killer Baby Drgons";
const TOKEN_IMAGE_NAME = "drgon.png";
const TOKEN_IMAGE_PATH = `tokens/drg/assets/${TOKEN_IMAGE_NAME}`;

async function createDrgToken(
...
async function main() {
    ...
    await createDrgToken(connection, payer);
}
